...
local iconUser = surface.GetTextureID( "icon16/user.png" )
...
function PANEL:SelectFirstItem()
	self:SelectItem( self:GetItems()[1], true )
end
...
derma.DefineControl( "EvolvePlayerList", "Stylish player list", PANEL, "DListBox" )
